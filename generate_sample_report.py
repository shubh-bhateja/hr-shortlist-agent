    ...
    scorecards = [
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=8.0, weighted_score=1.60, justification="Strong portfolio: fraud detection system, RAG pipeline, open-source contribution."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=8.0, weighted_score=0.80, justification="Resume is well-structured with clear impact metrics and action verbs."),
            ],
        ...
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=7.0, weighted_score=1.40, justification="Good portfolio with NLP projects, but no FinTech-specific work."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=7.5, weighted_score=0.75, justification="Clear and structured resume, good use of quantitative achievements."),
            ],
        ...
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=6.5, weighted_score=1.30, justification="2 academic ML projects. No production or industry portfolio."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=6.0, weighted_score=0.60, justification="Resume is functional but lacks impact metrics and specificity."),
            ],
        ...
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=4.5, weighted_score=0.90, justification="Dashboard and BI projects — not ML model development."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=5.5, weighted_score=0.55, justification="Adequate resume but lacks technical depth in descriptions."),
            ],
        ...
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=2.5, weighted_score=0.50, justification="React/Node.js projects — no ML or data science portfolio."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=6.0, weighted_score=0.60, justification="Well-written resume but for a completely different role."),
            ],
        ...
        CandidateScorecard(
            ...
            dimensions=[
                ...
                DimensionScore(dimension="Project / Portfolio", weight=0.20, raw_score=1.5, weighted_score=0.30, justification="Marketing campaigns and SEO projects — no ML relevance."),
                DimensionScore(dimension="Communication Quality", weight=0.10, raw_score=7.0, weighted_score=0.70, justification="Excellent writing quality but wrong domain entirely."),
            ],
